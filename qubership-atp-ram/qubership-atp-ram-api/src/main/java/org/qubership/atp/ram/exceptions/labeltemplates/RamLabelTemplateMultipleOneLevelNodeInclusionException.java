...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "RAM-5001")
public class RamLabelTemplateMultipleOneLevelNodeInclusionException extends AtpException {
