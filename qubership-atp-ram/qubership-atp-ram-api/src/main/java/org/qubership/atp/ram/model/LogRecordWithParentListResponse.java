...
@AllArgsConstructor
@NoArgsConstructor
public class LogRecordWithParentListResponse extends LogRecord {
    private List<LogRecordParent> parent;

    @EqualsAndHashCode(callSuper = true)
    @Data
    @AllArgsConstructor
    @NoArgsConstructor
    public static class LogRecordParent extends RamObject {
        private int depth;
