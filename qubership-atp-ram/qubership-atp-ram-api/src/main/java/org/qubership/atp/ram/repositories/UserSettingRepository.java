...
@Repository
public interface UserSettingRepository extends MongoRepository<AbstractUserSetting, UUID> {

    AbstractUserSetting findByUserIdAndType(UUID userId, UserSettingType type);
}
