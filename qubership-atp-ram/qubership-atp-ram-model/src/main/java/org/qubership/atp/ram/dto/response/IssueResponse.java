...
public class IssueResponse extends RamObject {

    private DefectPriority priority;
    private List<String> jiraTickets;
    private FailPatternResponse failPattern;
    private RamObjectResponse failReason;
    private String message;
    private List<IssueTestRunResponse> testRuns;
