...
@SpringBootTest(classes = PassedRateEmailSubjectMacros.class,
        webEnvironment = SpringBootTest.WebEnvironment.NONE,
        properties = {"spring.cloud.consul.config.enabled=false"})
public class PassedRateEmailSubjectMacrosIT {

    @Autowired
    private PassedRateEmailSubjectMacros macros;

    @Test
    public void resolve_testExecutionRequestPassedRateResolve_expectedSuccessfulResolve() {
        // given
        ...
        assertThat(resolvedValue)
                .isNotNull()
                .isEqualTo(String.valueOf(executionRequestPassedRate));
    }
}
