...
public class ExecutionRequestNameEmailSubjectMacrosIT {

    @Autowired
    private ExecutionRequestNameEmailSubjectMacros macros;

    @Test
    public void resolve_testExecutionRequestNameResolve_expectedSuccessfulResolve() {
        // given
        final String executionRequestName = "ER 1";
        ...
        assertThat(resolvedValue)
                .isNotNull()
                .isEqualTo(executionRequestName);
    }
}
