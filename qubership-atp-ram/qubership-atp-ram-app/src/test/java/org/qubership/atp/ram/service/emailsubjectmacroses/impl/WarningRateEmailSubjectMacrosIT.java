...
@SpringBootTest(classes = WarningRateEmailSubjectMacros.class,
        webEnvironment = SpringBootTest.WebEnvironment.NONE,
        properties = {"spring.cloud.consul.config.enabled=false"})
public class WarningRateEmailSubjectMacrosIT {

    @Autowired
    private WarningRateEmailSubjectMacros macros;

    @Test
    public void resolve_testExecutionWarningRateResolve_expectedSuccessfulResolve() {
        // given
        ...
        assertThat(resolvedValue)
                .isNotNull()
                .isEqualTo(String.valueOf(executionRequestWarningRate));
    }
}
