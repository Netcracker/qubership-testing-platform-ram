...
@Slf4j
@Service
public class ReportTemplateVersioningHistoryService extends AbstractVersioningHistoryService<ReportTemplate,
        ReportTemplateHistoryChangeDto> {

    public ReportTemplateVersioningHistoryService(Javers javers, ReportTemplateVersioningMapper mapper) {
        super(javers, mapper);
    }
