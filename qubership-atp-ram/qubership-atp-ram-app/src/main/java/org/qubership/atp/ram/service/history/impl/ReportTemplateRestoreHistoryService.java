...
@Slf4j
@Service
public class ReportTemplateRestoreHistoryService extends AbstractRestoreHistoryService<ReportTemplate> {

    public ReportTemplateRestoreHistoryService(
            Javers javers,
            ReportTemplatesService reportTemplatesService,
            ValidateReferenceExistsService<ReportTemplate> validateReferenceExistsService
    ) {
        super(javers, reportTemplatesService, validateReferenceExistsService);
    }
    ...
    public void restoreToRevision(UUID id, long revisionId) {
        super.restoreToRevision(id, revisionId);
    }
}
