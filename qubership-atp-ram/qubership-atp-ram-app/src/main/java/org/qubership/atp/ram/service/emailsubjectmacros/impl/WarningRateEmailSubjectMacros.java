...
@Slf4j
@Component
public class WarningRateEmailSubjectMacros implements ResolvableEmailSubjectMacros {
    ...
    public String resolve(ExecutionRequest executionRequest, ExecutionSummaryResponse executionSummaryResponse) {
        ...
        String warningRate = String.valueOf(executionSummaryResponse.getWarningRate());
        log.debug("Resolved value: {}", warningRate);
