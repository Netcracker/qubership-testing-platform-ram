...
public class StatusColumn extends Column {
    public StatusColumn(TestingStatuses status) {
        this(TestingStatusColor.of(status));
    }

    public StatusColumn(TestingStatusColor status) {
        super(status.getStatus(), BOLD, status.getColor());
    }
}
