...
@Slf4j
@Component
public class FailRateEmailSubjectMacros implements ResolvableEmailSubjectMacros {
    ...
    public String resolve(ExecutionRequest executionRequest, ExecutionSummaryResponse executionSummaryResponse) {
        ...
        log.debug("Start resolving macros 'FAIL_RATE' for execution request with id: {}",
                executionRequestId);

        String failedRate = String.valueOf(executionSummaryResponse.getFailedRate());
        log.debug("Resolved value: {}", failedRate);
