...
@Slf4j
@Service
public class FailPatternVersioningHistoryService extends AbstractVersioningHistoryService<FailPattern,
        FailPatternHistoryChangeDto> {

    public FailPatternVersioningHistoryService(Javers javers, FailPatternVersioningMapper mapper) {
        super(javers, mapper);
    }
