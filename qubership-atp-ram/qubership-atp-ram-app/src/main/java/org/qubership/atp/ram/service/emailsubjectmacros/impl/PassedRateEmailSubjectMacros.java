...
@Slf4j
@Component
public class PassedRateEmailSubjectMacros implements ResolvableEmailSubjectMacros {
    ...
    public String resolve(ExecutionRequest executionRequest, ExecutionSummaryResponse executionSummaryResponse) {
        ...
        log.debug("Start resolving macros 'PASSED_RATE' for execution request with id: {}",
                executionRequestId);

        String passedRate = String.valueOf(executionSummaryResponse.getPassedRate());
        log.debug("Resolved value: {}", passedRate);
