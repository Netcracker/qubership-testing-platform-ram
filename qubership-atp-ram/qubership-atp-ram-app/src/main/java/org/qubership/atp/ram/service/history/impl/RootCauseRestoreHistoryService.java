...
@Slf4j
@Service
public class RootCauseRestoreHistoryService extends AbstractRestoreHistoryService<RootCause> {

    public RootCauseRestoreHistoryService(Javers javers,
                                          RootCauseService rootCauseService,
                                          ValidateReferenceExistsService<RootCause> validateReferenceExistsService) {
        super(javers, rootCauseService, validateReferenceExistsService);
    }
